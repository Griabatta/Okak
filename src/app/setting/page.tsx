        ...
        switch (type) {
            ...
            case "Cabs": {
                ...
                const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/cabs`, {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify({ name: subjectName, institutionId: instId }),
                    credentials: "include", // Важно для кук!
                });
                if (res.status === 200) {
    ...
    return(
        <div>
            ...
            <form action="">
                ...
                {sendStatus.type === "Time" && sendStatus.code === 200? <p>Время было успешно добавлено</p> : undefined}
            ...
            <form action="">
                ...
                {sendStatus.type === "Cabs" && sendStatus.code === 200? <p>Кабинет был успешно добавлен</p> : undefined}
            ...
            <form action="">
                ...
                {sendStatus.type === "Subject" && sendStatus.code === 200? <p>Предмет был успешно добавлен</p> : undefined}
            ...
            <form action="">
                ...
                {sendStatus.type === "Teacher" && sendStatus.code === 200? <p>Преподаватель успешно добавлен</p> : undefined}
                <label htmlFor="teacherSurename">Фамилия:<span style={{color: "red"}}>*</span></label>
                <input type="text" id="teacherSurename" value={teacherName} onChange={(e) => setTeacherName(e.target.value)} />
                <label htmlFor="teacherName">Имя:<span style={{color: "red"}}>*</span></label>
                <input type="text" id="teacherName" value={teacherSurname} onChange={(e) => setTeacherSurname(e.target.value)} />
